...
> **결론 요약** — 전통적 OS 수식은 `Importance × 2 − Satisfaction`으로 펼쳐져 **중요도가 두 번 반영**됩니다. 그래서 중요한 항목은 이미 잘 풀렸어도 점수가 밀려 올라갑니다. AOS는 불만족을 `1 − Satisfaction/5`라는 비율로 따로 뽑아 Importance를 한 번만 곱합니다. 여기까지가 고객 한 명의 체감이고, 시장 규모를 곱한 DOS까지 가야 **팔리는 기회**가 됩니다. 사분면의 기준점을 무엇으로 잡느냐에 따라 같은 Pain이 혁신 기회에서 유지관리로 내려가므로, 기준점은 반드시 명시합니다.
